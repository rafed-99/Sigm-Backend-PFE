  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    http
        ...
        .requestMatchers(DELETE, "/api/geologie/couche/**").hasAuthority(GEOLOGIE_ADMIN_DELETE.name())
            ...
            .requestMatchers("/api/centre/analyse/**").hasAnyRole(CENTRE_ADMIN.name(),CENTRE_CONFIRM.name(),CENTRE_USER.name())
            .requestMatchers(GET, "/api/centre/analyse/**").hasAnyAuthority(CENTRE_ADMIN_READ.name(), CENTRE_CONFIRM_READ.name(), CENTRE_USER_READ.name())
            .requestMatchers(POST, "/api/centre/analyse/**").hasAnyAuthority(CENTRE_ADMIN_CREATE.name(), CENTRE_CONFIRM_CREATE.name(),CENTRE_USER_CREATE.name())
            .requestMatchers(PUT, "/api/centre/analyse/**").hasAnyAuthority(CENTRE_ADMIN_UPDATE.name(), CENTRE_CONFIRM_UPDATE.name(),CENTRE_USER_UPDATE.name())
            .requestMatchers(DELETE, "/api/centre/analyse/**").hasAnyAuthority(CENTRE_ADMIN_DELETE.name(),CENTRE_CONFIRM_DELETE.name(),CENTRE_USER_DELETE.name())
...
//        .requestMatchers("/api/user/admin/**").hasRole(USER.name())
            .requestMatchers("/api/user/admin/**").hasRole(ADMIN.name())
//
//        .requestMatchers(GET, "/api/user/admin/**").hasAuthority(USER_READ.name())

            .requestMatchers(GET, "/api/user/admin/**").hasAuthority(ADMIN_READ.name())
